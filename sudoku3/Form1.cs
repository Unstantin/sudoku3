    ...
    public partial class Form1 : Form
    {
        ...
        public void create_statistics_ui()
        {
            ...
            for (int i = 0; i < 3; i++)
            {
                ...
                if (i == 0) { label_statistics.Text += " À¿——»◊≈— Œ≈ —”ƒŒ ”\n\n";} 
                else if (i == 1) { label_statistics.Text += " »ÀÀ≈–-—”ƒŒ ”\n\n"; }
                else { label_statistics.Text += " »ÀÀ≈–-—”ƒŒ ”\n\n"; }

                label_statistics.Text += $"œŒ¡≈ƒ ¬—≈√Œ: {player.statistics[i].win_n}\n";
                if(player.statistics[i].playes_n == 0)
                {
                    label_statistics.Text += $"œ–Œ÷≈Õ“ œŒ¡≈ƒ: ¬€ ≈Ÿ≈ Õ»–¿«”\nÕ≈ —€√–¿À»\n";
                }
                else
                {
                    label_statistics.Text += $"œ–Œ÷≈Õ“ œŒ¡≈ƒ: {player.statistics[i].win_n / player.statistics[i].playes_n * 100} %\n";
                }
                label_statistics.Text += $"À”◊ÿ≈≈ ¬–≈Ãﬂ –≈ÿ≈Õ»ﬂ: {player.statistics[i].best_time / 1000 / 60} ÏËÌ {player.statistics[i].best_time / 1000 % 60} ÒÂÍ\n";
                label_statistics.Text += $" ŒÀ»◊≈—“¬Œ œŒ¡≈ƒ ¡≈« Œÿ»¡Œ : {player.statistics[i].win_without_mistakes_n}\n";
                ...
                {
                    label_statistics.Text += $"œ–Œ÷≈Õ“ œŒ¡≈ƒ ¡≈« Œÿ»¡Œ : ¬€ ≈Ÿ≈ Õ»–¿«”\nÕ≈ ¬€…√–¿À»\n";
                }
                else
                {
                    label_statistics.Text += $"œ–Œ÷≈Õ“ œŒ¡≈ƒ ¡≈« Œÿ»¡Œ : {player.statistics[i].win_without_mistakes_n / player.statistics[i].win_n}\n";
                }
